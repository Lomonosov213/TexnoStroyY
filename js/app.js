...
(function ($) {
   $(function () {
      ...
      $('ul.tabs-box__nav').on('click', 'li.tabs-box__item:not(.active)', function () {
         $(this)
            .addClass('active').siblings().removeClass('active')
            .closest('div.tabs-box__body').find('.tabs-box__block').removeClass('active').eq($(this).index()).addClass('active');
         // .closest('div.tabs-box__body').find('div.tabs-box__pict').removeClass('active').eq($(this).index()).addClass('active');
      });
      $('ul.tabs-box__nav').on('click', 'li:not(.active)', function () {
         $(this)
            .addClass('active').siblings().removeClass('active')
            // .closest('div.tabs-box__body').find('.tabs-box__block').removeClass('active').eq($(this).index()).addClass('active');
            .closest('div.tabs-box__body').find('div.tabs-box__pict').removeClass('active').eq($(this).index()).addClass('active');
...
$(window).scroll(function () {
   ...
   $('.countx').each(function () {
      ...
      var
         ...
         topWindow = $(window).scrollTop(); //настройка чтоб срабатывало когда доскролил
      if (cPos < topWindow + 900) { // на каком расстоянии от верха сработает счетчик
         //  if (cc < 2) { // условие чтоб счетчик срабатывал только один раз
         $('.sec32__itemR-num').addClass('viz');
         $('div').each(function () {
            var i = 1,
...
$('.sec35__title').on('click', function () {
   if ($('.sec35__title').hasClass("_active")) {
      $('.sec35__title').removeClass('_active');
      $('.sec35__img-box').slideToggle();
   } else {
      $('.sec35__title').addClass('_active');
      $('.sec35__img-box').slideToggle();
   }
})
...
$('.tabs-box__title').on('click', function () {
   if ($('.tabs-box__title').hasClass("_active")) {
      $('.tabs-box__title').removeClass('_active');
      $('.tabs-box__info').slideToggle();
   } else {
      $('.tabs-box__title').addClass('_active');
      $('.tabs-box__info').slideToggle();
   }
})

/*
$('.tabs-box__arrow-down').on('click', function () {
   var scroll = $('.tabs-box__right');
...
const block = document.querySelector('.tabs-box__right');
const scrolls = document.querySelector('.tabs-box__arrow-down');
scrolls.addEventListener('click', event => {
   scrollDiv();
});
*/
// скрипт для плавного проскролливания при нажатии на кнопку ========================================================================================================================================================
...
scroll.scrollBy({ left: 0, top: -300, behavior: "smooth" });
}, true);*/
...
let slider_about34 = new Swiper('.tabs-box__slider', {
	/*
	effect: 'fade',
	autoplay: {
		delay: 3000,
